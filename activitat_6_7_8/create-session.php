...
$checkout_session = \Stripe\Checkout\Session::create([
  ...
  'success_url' => $YOUR_DOMAIN . '/jgonzalez/M07/activitat_6_7_8/success.php?token='.$_SESSION["Token"],//si el pago es correcto
  'cancel_url' => $YOUR_DOMAIN . '/jgonzalez/M07/activitat_6_7_8/cancel.php',//si hay algun tipo de error
]);
